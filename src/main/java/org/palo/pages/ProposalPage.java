package org.palo.pages;

import com.github.javafaker.Faker;
import com.microsoft.playwright.Locator;
import com.microsoft.playwright.Page;
import org.palo.utils.ApplicationInformation;

import java.nio.file.Paths;
import java.text.SimpleDateFormat;
import java.util.Calendar;

import static org.palo.Factory.DriverFactory.applicationInformation;
...
public class ProposalPage {
    ...
    public void fillProposalDetails() {
        ...
        if (PROJECT_TITLE.isEnabled()) {
            ...
            PROJECT_TITLE.fill(applicationInformation.getPROJECT_TITLE());
