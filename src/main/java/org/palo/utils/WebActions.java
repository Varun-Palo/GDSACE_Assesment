...
public abstract class WebActions {
    ...
    public static String getValuefromDisbaledElement(String selector) {
        ElementHandle inputElement = DriverFactory.getPage().querySelector(selector);
